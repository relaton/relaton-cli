...
* `ietf-rfcsubseries` - https://www.rfc-editor.org/rfc-index.xml (only in special XML https://github.com/relaton/relaton-ietf#fetch-data[format])
* `ietf-internet-drafts` - https://www.ietf.org/lib/dt/sprint/bibxml-ids.tgz
* `ietf-rfc-entries` - https://www.rfc-editor.org/rfc-index.xml
